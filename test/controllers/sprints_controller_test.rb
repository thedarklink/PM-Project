...
class SprintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post sprints_url, params: { sprint: { effort: @sprint.effort, endDate: @sprint.endDate, name: @sprint.name, remainingWork: @sprint.remainingWork, startDate: @sprint.startDate } }
    end
  ...
  test "should update sprint" do
    patch sprint_url(@sprint), params: { sprint: { effort: @sprint.effort, endDate: @sprint.endDate, name: @sprint.name, remainingWork: @sprint.remainingWork, startDate: @sprint.startDate } }
